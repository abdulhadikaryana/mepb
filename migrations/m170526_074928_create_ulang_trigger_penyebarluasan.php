...
class m170526_074928_create_ulang_trigger_penyebarluasan extends Migration
{
    public function up()
    {
        ...
        $trigger = <<<EOT
            ...
            BEGIN
                INSERT INTO penyebarluasan_history VALUES (NULL, OLD.id, OLD.created_by,
                    ...
                    OLD.rev_no, OLD.setuju_status_upt, OLD.setuju_tanggal_upt, OLD.setuju_oleh_upt);
...
EOT;
        ...
        echo "m170526_074928_create_ulang_trigger_penyebarluasan cannot be reverted.\n";
    }
