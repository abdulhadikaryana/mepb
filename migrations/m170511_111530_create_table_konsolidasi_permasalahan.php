...
class m170511_111530_create_table_konsolidasi_permasalahan extends Migration
{
    public function up()
    {
        $this->createTable('konsolidasi', [
            'id' => $this->primaryKey(),
            ...
            'metode' => $this->string(255)->notNull(),
            'sub_metode' => $this->string(255),
            'deskripsi' => $this->text()->notNull(),
            'solusi' => $this->string(255),
            'foto1' => 'Longtext',
            'foto2' => 'Longtext',
            'foto3' => 'Longtext',
        ...
        $this->createTable('konsolidasi_history', [
            'id' => $this->primaryKey(),
            'konsolidasi_id' => $this->integer(),
            'created_by' => $this->integer(),
            'updated_by' => $this->integer(),
            'created_at' => $this->integer(),
            'updated_at' => $this->integer(),
        ...
        // add foreign key for table `konsolidasi_history`
        $this->addForeignKey(
            'fk-history_konsolidasi-konsolidasi_id',
            'konsolidasi_history',
            'konsolidasi_id',
            'konsolidasi',
            'id',
        ...
        $trigger = <<<EOT
            ...
            BEGIN
                ...
                OLD.rev_komentar, OLD.rev_oleh, OLD.rev_no);
...
EOT;
        ...
        $this->dropTable('konsolidasi_history');
        $this->dropTable('konsolidasi');
        echo "m170511_111530_create_table_konsolidasi_permasalahan cannot be reverted.\n";
    }
