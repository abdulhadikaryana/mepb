                ...
                <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'template' => '{detail-konsolidasi} {approve-konsolidasi}',
                                'buttons' => [
                                    'detail-konsolidasi' => function($url, $model) {
                                        return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', $url);
                                    },
                                    'approve-konsolidasi' => function($url, $model) {
                                        return Html::a('<span class="glyphicon glyphicon-thumbs-up"></span>', $url, ['data-toggle' => 'modal', 'data-target' => '#approveModal',]);
                                    }
                                ]
                            ]
                        ],
