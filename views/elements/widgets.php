...
$this->title = 'Widgets';
app\assets\GentelellaElementsWidgetsPluginAsset::register($this);
$directoryAsset = Yii::$app->assetManager->getPublishedUrl('@bower/gentelella/production');
?>
<div class="element-widgets">
                          ...
                          <div class="x_content">
                            ...
                            <div class="flex">
                              <ul class="list-inline widget_profile_box">
                                ...
                                <li>
                                  <img src="<?=$directoryAsset;?>/images/user.png" alt="..." class="img-circle profile_img">
                                </li>
                                <li>
                                  <a>
