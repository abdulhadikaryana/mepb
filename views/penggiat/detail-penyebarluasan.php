...
$this->params['breadcrumbs'][] = ['label' => 'Penyebarluasan', 'url' => ['/penggiat/penyebarluasan']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="konsolidasi-view">
    <p>
        <?= Html::a('<i class="fa fa-edit"></i> Ubah', ['/penggiat/edit-penyebarluasan', 'id' => $model->id], ['class' => 'btn btn-primary']) ?>
    </p>
    <div class="row">
