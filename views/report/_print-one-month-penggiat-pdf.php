...
<html>
    ...
    <body>
        <div class="page">
                    ...
                    <td>
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td>
                                    : <?=strtoupper($dataPenggiat->fullname); ?>
                                </td>
                            </tr>
                            <tr>
                                <td width="15%">
                            ...
                            <tr>
                                ...
                                <td>
                                    : <?=$dataPenggiat->kabkota_id ? $dataPenggiat->kabkota->nama_kabkota : '-';?>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    : <?=$dataPenggiat->provinsi_id ? $dataPenggiat->provinsi->nama_provinsi : '-';?>
                                </td>
                            </tr>
                        </table>
                    </td>
            ...
            <table border="0">
                <tr>
                    <td style="text-align: center;">Menyetujui<br/><?=$dataPenggiat->dinas ? $dataPenggiat->dinas->jabatan : '-';?></td>
                    <td width="25%"></td>
                    <td style="text-align: center;">Mengetahui<br/><?=$dataPenggiat->upt ? $dataPenggiat->upt->jabatan : '-';?></td>
                </tr>
                <tr>
                    <td height="2 cm" style="text-align: center;">TTD</td>
                    <td></td>
                    <td style="text-align: center;">TTD</td>
                </tr>
                <tr>
                    <td style="text-align: center; border-bottom: 1px solid #000"><?=$dataPenggiat->dinas ? $dataPenggiat->dinas->fullname : '-';?></td>
                    <td width="35%"></td>
                    <td style="text-align: center; border-bottom: 1px solid #000"><?=$dataPenggiat->upt ? $dataPenggiat->upt->fullname : '-';?></td>
                </tr>
            </table>
        </div>
    </body>
