            ...
            <div class="x_panel">
                <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                        <li >
                            <?=Html::a('<i class="fa fa-thumbs-up"></i>', ['approve-konsolidasi', 'id' => $model->id], ['class' => 'btn btn-xs','data-toggle' => 'modal', 'data-target' => '#approveModal', 'data-title' => 'Pernyataan'])?>
                        </li>
                        <li >
                            <?=Html::a('<i class="fa fa-comment"></i>', ['comment-konsolidasi', 'id' => $model->id], ['class' => 'btn btn-xs','data-toggle' => 'modal', 'data-target' => '#commentModal', 'data-title' => 'Masukan/Revisi'])?>
                        </li>
                    </ul>
