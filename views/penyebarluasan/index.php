...
?>
<div class="penyebarluasan-index">

    <p>
        <?php if(Helper::checkRoute('create')){ ?>
        <?= Html::a('<i class="fa fa-plus"></i> Penyebarluasan Informasi', ['create'], ['class' => 'btn btn-success']) ?>
        <?php } ?>
        <?php if(Helper::checkRoute('/manual-entry/penyebarluasan')){ ?>
        <?= Html::a('<i class="fa fa-plus"></i> Penyebarluasan Informasi', ['/manual-entry/penyebarluasan'], ['class' => 'btn btn-success']) ?>
        <?php } ?>
    </p>
    <?php Pjax::begin(); ?>
    <div class="row">
                            ...
                            [
                                ...
                                'buttons' => [
                                    'view' => function($url, $model) {
                                        if(\Yii::$app->user->can('penyebarluasanOwnView', ['model' => $model]) OR \Yii::$app->user->can('SuperAdmin', ['model' => $model])) {
                                            return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', $url);
                                        }
                                    },
                                    'update' => function($url, $model) {
                                        if(\Yii::$app->user->can('penyebarluasanOwnUpdate', ['model' => $model]) OR \Yii::$app->user->can('SuperAdmin', ['model' => $model])) {
